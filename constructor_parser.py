...
class ConstructorParser:
  ...
  def constructor_update(self, urls):
    ...
    for key, value in constructor_info.items():
      request = requests.patch(f'http://formula-1-pitstop.vercel.app/api/constructors/{key}', json=value)
